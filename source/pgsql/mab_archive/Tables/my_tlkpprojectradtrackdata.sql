CREATE TABLE IF NOT EXISTS mabarchive.my_tlkpprojectradtrackdata (
...
-- Foreign keys for mabarchive.my_tlkpprojectradtrackdata
DO $$ BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_constraint
        WHERE conname = 'fk_my_tlkpprojectradtrackdata_g_tlkpproject_radtrackdata'
          AND conrelid = 'mabarchive.my_tlkpprojectradtrackdata'::regclass
    ) THEN
        ALTER TABLE mabarchive.my_tlkpprojectradtrackdata
