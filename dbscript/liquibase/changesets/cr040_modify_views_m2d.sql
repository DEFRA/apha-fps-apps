...
--changeset repo-admin:CR040 labels:ddl context:all
--comment Recreate FPS views for money->numeric(19,4) migration. Float/double precision expressions are intentionally unchanged.
