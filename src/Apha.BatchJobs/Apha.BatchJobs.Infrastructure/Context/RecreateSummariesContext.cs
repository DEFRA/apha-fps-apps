...
/// <summary>Scoped holder for RecreateSummaries run parameters.</summary>
public sealed class RecreateSummariesContext : IRecreateSummariesContext
{
    /// <summary>Initializes context from optional environment overrides. Defaults remain month=1 and triggeredBy=system for backward compatibility.</summary>
