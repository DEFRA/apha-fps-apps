...
/// <summary>Represents a row from fps.tblstagingprofitcentregrade for a specific request. Maps to Staff profit-centre grade staging data uploaded by the initiator.</summary>
