...
/// <summary>Represents a row from fps.tblstagingtlkptestreqmt for a specific request. Maps to AGRUP (tlkpTestReqmt) staging data uploaded by the initiator.</summary>
