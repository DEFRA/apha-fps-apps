...
/// <summary>Thrown when a business notification email cannot be sent (e.g. SMTP failure, invalid recipient, or email service unavailable). Maps to exit code <see cref="Constants.BatchExitCodes.EmailFailure"/> (50).</summary>
