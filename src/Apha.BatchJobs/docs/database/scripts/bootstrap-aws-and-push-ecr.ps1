...
./docs/database/scripts/bootstrap-aws-and-push-ecr.ps1 -PushOnly -Region eu-west-2

.EXAMPLE
# Full bootstrap + push
./docs/database/scripts/bootstrap-aws-and-push-ecr.ps1 -CreateCoreResources -PushImage -Region eu-west-2
#>
