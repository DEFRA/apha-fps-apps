...
/// stays isolated to orchestration/claim behaviour.
/// </summary>
/// <remarks>
...
/// <c>batchjob_testing</c>, which is read-only-verification-only for this work. Point
/// <c>ConnectionStrings__FPSConnectionString</c> at a disposable database that already has the
/// CR048 catalogue (hyphenated job names, 7-state lifecycle) applied; otherwise this class
/// self-skips via <see cref="_yearEndHyphenatedCatalogAvailable"/>.
/// </remarks>
