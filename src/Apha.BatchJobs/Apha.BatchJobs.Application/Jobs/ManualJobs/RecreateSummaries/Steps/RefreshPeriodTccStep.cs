...
/// <summary>
/// Step 17 (conditional) — Refreshes <c>fps.period_timecostcalcs</c> for the given period.
/// Only executed when <c>tblperiod.periodlocked = 0</c>.
/// </summary>
/// <remarks>Replaces <c>usp_Refresh_Period_TCC @month</c>.</remarks>
public sealed class RefreshPeriodTccStep : RecreateSummariesStepBase
{
    private readonly string _sql;
    private readonly int _month;

    public RefreshPeriodTccStep(string sql, int month)
    {
        _sql = sql;
        _month = month;
    }
