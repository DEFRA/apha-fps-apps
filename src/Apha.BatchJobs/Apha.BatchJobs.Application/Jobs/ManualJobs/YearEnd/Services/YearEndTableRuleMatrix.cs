...
public enum YearEndTableRole
{
    ...
    /// <summary>
    /// Spec §19 legacy candidates — year-scoped (partitioned by <c>fpsyear</c>) but must start
    /// empty in the target year, cleared by <see cref="TargetYearEmptyTablesStep"/> and verified
    /// empty by <see cref="FinalValidationStep"/>. Not Table 23 business participants.
    /// </summary>
...
public enum YearEndTableRuleAction
{
    ...
    /// <summary>
    /// Target-year rows for this table must be deleted/absent — owned by
    /// <see cref="TargetYearEmptyTablesStep"/>, verified by <see cref="FinalValidationStep"/>.
    /// </summary>
    ClearTargetYearRows,
...
/// (<see cref="ResetPhase"/>/<see cref="Overrides"/>-driven resets), <see cref="TargetYearEmptyTablesStep"/>
/// (<see cref="YearEndTableRuleAction.ClearTargetYearRows"/>-driven clearing), and
...
public static class YearEndTableRuleMatrix
{
    ...
    [
        ...
        // LIST(fpsyear) partitioned tables like the Table 23 set, all have a real primary key. No
        // evidence any of the 21 is environment-optional in this scan; the runtime TableExistsAsync
        // skip-if-missing behaviour in TargetYearEmptyTablesStep/FinalValidationStep stays as a
        // defensive measure regardless, unchanged from before this migration.
        new(Schema, "additionalcosts_log", YearEndTableRole.YearScopedTargetMustBeEmpty, YearEndTableRuleAction.ClearTargetYearRows, ["sequenceno", "fpsyear"]),
        new(Schema, "animalreq_log", YearEndTableRole.YearScopedTargetMustBeEmpty, YearEndTableRuleAction.ClearTargetYearRows, ["sequenceno", "fpsyear"]),
        new(Schema, "fpsyeartotals", YearEndTableRole.YearScopedTargetMustBeEmpty, YearEndTableRuleAction.ClearTargetYearRows, ["parentproject", "fpsyear"]),
        new(Schema, "mo_log", YearEndTableRole.YearScopedTargetMustBeEmpty, YearEndTableRuleAction.ClearTargetYearRows, ["sequenceno", "fpsyear"]),
        new(Schema, "monthlyoutput", YearEndTableRole.YearScopedTargetMustBeEmpty, YearEndTableRuleAction.ClearTargetYearRows, ["testcode", "buyer", "month", "workgroup", "fpsyear"]),
        new(Schema, "monthlytime", YearEndTableRole.YearScopedTargetMustBeEmpty, YearEndTableRuleAction.ClearTargetYearRows, ["pactstaffid", "timecode", "month", "parentproject", "fpsyear"]),
        new(Schema, "mt_log", YearEndTableRole.YearScopedTargetMustBeEmpty, YearEndTableRuleAction.ClearTargetYearRows, ["sequenceno", "fpsyear"]),
        new(Schema, "proj_invoice", YearEndTableRole.YearScopedTargetMustBeEmpty, YearEndTableRuleAction.ClearTargetYearRows, ["invoicecounter", "fpsyear"]),
        new(Schema, "proj_subcontract", YearEndTableRole.YearScopedTargetMustBeEmpty, YearEndTableRuleAction.ClearTargetYearRows, ["subcontcounter", "fpsyear"]),
        new(Schema, "project_log", YearEndTableRole.YearScopedTargetMustBeEmpty, YearEndTableRuleAction.ClearTargetYearRows, ["sequenceno", "fpsyear"]),
        new(Schema, "projectmonth", YearEndTableRole.YearScopedTargetMustBeEmpty, YearEndTableRuleAction.ClearTargetYearRows, ["project", "monthno", "fpsyear"]),
        new(Schema, "projectmonthfinal", YearEndTableRole.YearScopedTargetMustBeEmpty, YearEndTableRuleAction.ClearTargetYearRows, ["project", "monthno", "fpsyear"]),
        new(Schema, "recreatesummaries_log", YearEndTableRole.YearScopedTargetMustBeEmpty, YearEndTableRuleAction.ClearTargetYearRows, ["id", "fpsyear"]),
        new(Schema, "staffjob_log", YearEndTableRole.YearScopedTargetMustBeEmpty, YearEndTableRuleAction.ClearTargetYearRows, ["sequenceno", "fpsyear"]),
        new(Schema, "tblbid", YearEndTableRole.YearScopedTargetMustBeEmpty, YearEndTableRuleAction.ClearTargetYearRows, ["workgroup", "account", "fpsyear"]),
        new(Schema, "tblpurchase", YearEndTableRole.YearScopedTargetMustBeEmpty, YearEndTableRuleAction.ClearTargetYearRows, ["workgroup", "account", "itemdescription", "fpsyear"]),
        new(Schema, "tblsurvff_fees", YearEndTableRole.YearScopedTargetMustBeEmpty, YearEndTableRuleAction.ClearTargetYearRows, ["owning_vic", "contract", "record_id", "fpsyear"]),
        new(Schema, "tblsurvff_submissions", YearEndTableRole.YearScopedTargetMustBeEmpty, YearEndTableRuleAction.ClearTargetYearRows, ["sd_pact_wg", "contract", "fpsyear"]),
        new(Schema, "tbltestreqbaseline", YearEndTableRole.YearScopedTargetMustBeEmpty, YearEndTableRuleAction.ClearTargetYearRows, ["program", "testcode", "buyer", "fpsyear"]),
        new(Schema, "testreq_log", YearEndTableRole.YearScopedTargetMustBeEmpty, YearEndTableRuleAction.ClearTargetYearRows, ["sequenceno", "fpsyear"]),
        new(Schema, "timecostcalcs", YearEndTableRole.YearScopedTargetMustBeEmpty, YearEndTableRuleAction.ClearTargetYearRows, ["workgroup", "jobcode", "project", "month", "staffid", "fpsyear"])
    ];
}
