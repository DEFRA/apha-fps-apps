...
/// <summary>Invoked by the Orchestrator after a job is durably marked Completed and its lock released. Implementations are best-effort; failures must never propagate into the job lifecycle.</summary>
