...
{
    /// <summary>
    /// Entity representing the fps.vtlkpproject database view.
    /// Used by the PACT JobCode repository for ZT job code lookup queries.
    /// </summary>
    public class ProjectView
    {
        // --- Key lookup fields (used by ZT query) ---
