...
namespace Apha.PACT.Api.Controllers
{
    ...
    [ApiController]
    [ApiVersion("1.0")]
    [Route("api/v{version:apiVersion}/calendermonths")]
    public class CalenderMonthController : ControllerBase
    {
        ...
        /// <summary>Retrieves all calender months.</summary>
        [HttpGet]
        public async Task<IActionResult> GetAll()
        {
            IEnumerable<CalenderMonthDto> months = await _service.GetAllCalenderMonthsAsync();
            return Ok(_mapper.Map<IEnumerable<CalenderMonthRes>>(months));
        }
    }
}
