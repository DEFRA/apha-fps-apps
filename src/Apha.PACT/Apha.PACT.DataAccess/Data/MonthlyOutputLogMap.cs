...
namespace Apha.PACT.DataAccess.Data
{
    public class MonthlyOutputLogMap : IEntityTypeConfiguration<MonthlyOutputLog>
    {
        ...
        {
            entity.HasKey(e => new { e.SequenceNo, e.FpsYear }).HasName("pk_mo_log");

            entity.ToTable("mo_log", "fps");

            entity.Property(e => e.SequenceNo)
                .ValueGeneratedOnAdd()
                .HasComment("This column uses GENERATED ALWAYS AS IDENTITY, which is equivalent to IDENTITY in SQL Server.")
