...
namespace Apha.Common.Helpers.Repository
{
    ...
    public static class RepositoryTestHelper
    {
        ...
        /// Transaction support is configured automatically via SetupTransaction.
        /// </summary>
        ...
        /// <summary>
        /// Configures Database.BeginTransactionAsync() on a mock DbContext so that
        /// repositories using transactions do not throw a NullReferenceException.
        /// </summary>
        /// <typeparam name="TContext">The DbContext type</typeparam>
        /// <param name="mockContext">The mock context to configure.</param>
        public static void SetupTransaction<TContext>(Mock<TContext> mockContext)
            where TContext : DbContext
        {
            ...
            var mockDatabase = new Mock<DatabaseFacade>(new Mock<DbContext>(new DbContextOptions<DbContext>()).Object);
            mockDatabase
