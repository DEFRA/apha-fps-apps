...
namespace Apha.FPSApps.Infrastructure.Integrations.PACTApis.Clients
{
    public class PactProjectInvoiceApiClient : IPactProjectInvoiceApiClient
    {
        ...
        public async Task<ApiResponseDto<List<ProjectInvoiceDto>>> GetPagedProjectInvoicesAsync(QueryParameters<string> query, string? parentProject)
        {
            ...
            {
                return ApiResponseDto<List<ProjectInvoiceDto>>.FailureResponse(
                    [new ApiErrorDto { Message = "Failed to retrieve project invoices", Code = InternalCodeError }],
                    new ApiMetaDto());
            }
        }
        ...
        public async Task<ApiResponseDto<ProjectInvoiceDto>> GetByIdAsync(int invoiceCounter)
        {
            ...
            {
                return ApiResponseDto<ProjectInvoiceDto>.FailureResponse(
                    [new ApiErrorDto { Message = "Failed to retrieve project invoice", Code = InternalCodeError }],
                    new ApiMetaDto());
            }
        }
        ...
        public async Task<ApiResponseDto<ProjectInvoiceDto>> CreateAsync(ProjectInvoiceDto dto)
        {
            ...
            {
                return ApiResponseDto<ProjectInvoiceDto>.FailureResponse(
                    [new ApiErrorDto { Message = "Failed to create project invoice", Code = InternalCodeError }],
                    new ApiMetaDto());
            }
        }
        ...
        public async Task<ApiResponseDto<ProjectInvoiceDto>> UpdateAsync(int invoiceCounter, ProjectInvoiceDto dto)
        {
            ...
            {
                return ApiResponseDto<ProjectInvoiceDto>.FailureResponse(
                    [new ApiErrorDto { Message = "Failed to update project invoice", Code = InternalCodeError }],
                    new ApiMetaDto());
            }
        }
        ...
        public async Task<ApiResponseDto<bool>> DeleteAsync(int invoiceCounter)
        {
            ...
            catch (Exception)
            {
                return ApiResponseDto<bool>.FailureResponse(
                    [new ApiErrorDto { Message = "Failed to delete project invoice", Code = InternalCodeError }],
                    new ApiMetaDto());
            }
        }
        ...
        public async Task<ApiResponseDto<decimal>> GetTotalAmountAsync(string? parentProject)
        {
            ...
            catch (Exception)
            {
                return ApiResponseDto<decimal>.FailureResponse(
                    [new ApiErrorDto { Message = "Failed to retrieve invoice total amount", Code = InternalCodeError }],
                    new ApiMetaDto());
            }
        }
    }
