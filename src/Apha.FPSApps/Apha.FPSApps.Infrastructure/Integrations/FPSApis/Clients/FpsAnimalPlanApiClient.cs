...
namespace Apha.FPSApps.Infrastructure.Integrations.FPSApis.Clients
{
    public class FpsAnimalPlanApiClient : IFpsAnimalPlanApiClient
    {
        ...
        public async Task<ApiResponseDto<List<AnimalCostViewDto>>> GetAllAnimalCostAsync(QueryParameters<string> query, string jobCode)
        {
            ...
            {
                return ApiResponseDto<List<AnimalCostViewDto>>.FailureResponse(
                    [new ApiErrorDto { Message = "Failed to retrieve animal costs", Code = InternalCodeError }],
                    new ApiMetaDto());
            }
        }
        ...
        public async Task<ApiResponseDto<List<AnimalDto>>> GetAnimalLookupAsync()
        {
            ...
            catch (Exception)
            {
                return ApiResponseDto<List<AnimalDto>>.FailureResponse(
                    [new ApiErrorDto { Message = "Failed to retrieve animal lookup", Code = InternalCodeError }],
                    new ApiMetaDto());
            }
        }
        ...
        public async Task<ApiResponseDto<decimal?>> GetAnimalRateAsync(string animalType)
        {
            ...
            catch (Exception)
            {
                return ApiResponseDto<decimal?>.FailureResponse(
                    [new ApiErrorDto { Message = "Failed to retrieve animal rate", Code = InternalCodeError }],
                    new ApiMetaDto());
            }
        }
        ...
        public async Task<ApiResponseDto<AnimalRequestDto>> CreateAnimalCostAsync(AnimalRequestDto animalRequest)
        {
            ...
            {
                return ApiResponseDto<AnimalRequestDto>.FailureResponse(
                    [new ApiErrorDto { Message = "Failed to create animal cost", Code = InternalCodeError }],
                    new ApiMetaDto());
            }
        }
        ...
        public async Task<ApiResponseDto<AnimalRequestDto>> UpdateAnimalCostAsync(AnimalRequestDto animalRequest)
        {
            ...
            {
                return ApiResponseDto<AnimalRequestDto>.FailureResponse(
                    [new ApiErrorDto { Message = "Failed to update animal cost", Code = InternalCodeError }],
                    new ApiMetaDto());
            }
        }
        ...
        public async Task<ApiResponseDto<bool>> DeleteAnimalCostAsync(int indCounter)
        {
            ...
            catch (Exception)
            {
                return ApiResponseDto<bool>.FailureResponse(
                    [new ApiErrorDto { Message = "Failed to delete animal cost", Code = InternalCodeError }],
                    new ApiMetaDto());
            }
        }
        ...
        public async Task<ApiResponseDto<decimal>> GetTotalAnimalCostAsync(string jobCode)
        {
            ...
            {
                return ApiResponseDto<decimal>.FailureResponse(
                    [new ApiErrorDto { Message = "Failed to retrieve total animal cost", Code = InternalCodeError }],
                    new ApiMetaDto());
            }
        }
        ...
        public async Task<ApiResponseDto<AnimalCostViewDto?>> GetAnimalCostViewByIdAsync(int indCounter, string jobCode)
        {
            ...
            {
                return ApiResponseDto<AnimalCostViewDto?>.FailureResponse(
                    [new ApiErrorDto { Message = "Failed to retrieve animal cost view", Code = InternalCodeError }],
                    new ApiMetaDto());
            }
        }
    }
