...
namespace Apha.FPSApps.Web.Areas.FPS.Models
{
    ...
    public class YearEndMonthWorkingItem
    {
        ...
        [GridColumn(Order = 3, Width = 100, Type = GridColumnType.Text)]
        ...
        [Display(Name = "Month")]
        [GridColumn(Order = 6, Width = 60, Type = GridColumnType.Text)]
        public short Month { get; set; }

        [Display(Name = "Fmonth")]
        [GridColumn(Order = 7, Width = 60, Type = GridColumnType.Text)]
        public short? Fmonth { get; set; }

        [Display(Name = "FpsYear")]
