...
namespace Apha.FPSApps.Web.Areas.FPS.Models
{
    public class WorkGroupEmployeeStaffItem
    {
        ...
        [GridColumn(Width = 70, Type = GridColumnType.Text, IsFilterable = true)]
        ...
        [NonFinancialRange]
        [GridColumn(Width = 80, Type = GridColumnType.DecimalNumber, IsFilterable = true)]
        public double HrsPaid { get; set; }

        [Display(Name = "Leave")]
        [Required(ErrorMessage = "Leave is required")]
        [NonFinancialRange]
        [GridColumn(Width = 70, Type = GridColumnType.DecimalNumber, IsFilterable = true)]
        public double Leave { get; set; }

        [Display(Name = "Sick Special")]
        [Required(ErrorMessage = "Sick Special is required")]
        [NonFinancialRange]
        [GridColumn(Width = 95, Type = GridColumnType.DecimalNumber, IsFilterable = true)]
        public double SickSpecial { get; set; }

        [Display(Name = "HrsAvail")]
        [Required(ErrorMessage = "HrsAvail is required")]
        [NonFinancialRange]
        [GridColumn(Width = 90, Type = GridColumnType.DecimalNumber, IsFilterable = true)]
        public double HrsAvail { get; set; }

        [Display(Name = "Available?")]
        [GridColumn(Width = 90, Type = GridColumnType.Checkbox, IsFilterable = true)]
        public bool MakeAvailable { get; set; }

        [Display(Name = "Time recorder?")]
        [GridColumn(Width = 105, Type = GridColumnType.Checkbox, IsFilterable = true)]
        public bool TimeRecorder { get; set; }

        [Display(Name = "Start Date")]
        [GridColumn(Width = 110, Type = GridColumnType.Date, IsFilterable = true)]
        ...
        [NonFinancialRange]
        [GridColumn(Width = 115, Type = GridColumnType.DecimalNumber, IsFilterable = true)]
