        ...
        public IActionResult Index()
        {
            ...
            var viewModel = new TestListVlaViewModel
            {
                ...
                TestListGrid = new DataGridConfig<TestListVlaItem>
                {
                    ...
                    BindGridUrl         = $"/FPS/TestListVla/LoadTestListVlaGrid?fpsContextYear={fpsYear}",
                ...
                TestRequirementsGrid = new DataGridConfig<TestRequirementItem>
                {
                    ...
                    BindGridUrl         = $"/FPS/TestListVla/LoadTestRequirementsGrid?fpsContextYear={fpsYear}",
                ...
                ComponentChargesGeneralGrid = new DataGridConfig<TestRCCostItem>
                {
                    ...
                    BindGridUrl         = $"/FPS/TestListVla/LoadComponentChargesGeneralGrid?fpsContextYear={fpsYear}",
                ...
                ComponentChargesProjectGrid = new DataGridConfig<TestRequirementRCCostItem>
                {
                    ...
                    BindGridUrl         = $"/FPS/TestListVla/LoadComponentChargesProjectGrid?fpsContextYear={fpsYear}",
                ...
                SuppliersGrid = new DataGridConfig<TestCapabilityItem>
                {
                    ...
                    BindGridUrl         = $"/FPS/TestListVla/LoadSuppliersGrid?fpsContextYear={fpsYear}",
