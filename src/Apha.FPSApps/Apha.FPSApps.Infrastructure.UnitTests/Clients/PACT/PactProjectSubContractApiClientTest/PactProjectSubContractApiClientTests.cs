...
namespace Apha.FPSApps.Infrastructure.UnitTests.Clients.PACT.PactProjectSubContractApiClientTest
{
    public class PactProjectSubContractApiClientTests
    {
        ...
        public async Task GetByIdAsync_WithValidId_ReturnsMappedSubContract()
        {
            ...
            _http.GetAsync<ProjectSubContractRes>($"api/v1/projectsubcontract/id?id={subContCounter}").Returns(apiResponse);
            ...
            await _http.Received(1).GetAsync<ProjectSubContractRes>($"api/v1/projectsubcontract/id?id={subContCounter}");
        }
        ...
        public async Task UpdateAsync_WithValidSubContract_ReturnsMappedUpdatedSubContract()
        {
            ...
            _mapper.Map<ProjectSubContractReq>(subContractDto).Returns(subContractReq);
            _http.PutAsync<ProjectSubContractReq, ProjectSubContractRes>($"api/v1/projectsubcontract/id?id={subContCounter}", subContractReq).Returns(apiResponse);
            _mapper.Map<ApiResponseDto<ProjectSubContractDto>>(apiResponse).Returns(expectedDto);
            ...
            await _http.Received(1).PutAsync<ProjectSubContractReq, ProjectSubContractRes>($"api/v1/projectsubcontract/id?id={subContCounter}", subContractReq);
        }
        ...
        public async Task DeleteAsync_WithValidId_ReturnsSuccess()
        {
            ...
            _http.DeleteAsync<bool?>($"api/v1/projectsubcontract/id?id={subContCounter}").Returns(apiResponse);
            ...
            Assert.True(result.Success);
            Assert.True(result.Data);
            await _http.Received(1).DeleteAsync<bool?>($"api/v1/projectsubcontract/id?id={subContCounter}");
        }
