...
namespace Apha.FPSApps.Infrastructure.UnitTests.Clients.PACT.PactProjectInvoiceApiClientTest
{
    public class PactProjectInvoiceApiClientTests
    {
        ...
        public async Task GetByIdAsync_WithValidId_ReturnsMappedInvoice()
        {
            ...
            _http.GetAsync<ProjectInvoiceRes>($"api/v1/projectinvoice/id?id={invoiceCounter}").Returns(apiResponse);
            ...
            await _http.Received(1).GetAsync<ProjectInvoiceRes>($"api/v1/projectinvoice/id?id={invoiceCounter}");
        }
        ...
        public async Task UpdateAsync_WithValidInvoice_ReturnsMappedUpdatedInvoice()
        {
            ...
            _http.PutAsync<ProjectInvoiceReq, ProjectInvoiceRes>($"api/v1/projectinvoice/id?id={invoiceCounter}", Arg.Any<ProjectInvoiceReq>()).Returns(apiResponse);
            ...
            await _http.Received(1).PutAsync<ProjectInvoiceReq, ProjectInvoiceRes>($"api/v1/projectinvoice/id?id={invoiceCounter}", Arg.Any<ProjectInvoiceReq>());
        }
        ...
        public async Task DeleteAsync_WithValidId_ReturnsSuccess()
        {
            ...
            _http.DeleteAsync<bool?>($"api/v1/projectinvoice/id?id={invoiceCounter}").Returns(apiResponse);
            ...
            await _http.Received(1).DeleteAsync<bool?>($"api/v1/projectinvoice/id?id={invoiceCounter}");
        }
