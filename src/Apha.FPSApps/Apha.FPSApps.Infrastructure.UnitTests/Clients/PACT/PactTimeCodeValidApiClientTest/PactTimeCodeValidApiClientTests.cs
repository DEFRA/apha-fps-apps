...
namespace Apha.FPSApps.Infrastructure.UnitTests.Clients.PACT.PactTimeCodeValidApiClientTest
{
    public class PactTimeCodeValidApiClientTests
    {
        ...
        [Fact]
        public async Task GetPagedTimeCodesTestCodeAsync_WithAllParameters_IncludesAllInUrl()
        {
            // Arrange
            var query = new QueryParameters<string> { Page = 1, PageSize = 10 };
            var jobCode = "JC001";
            ...
            var timeCodeList = new List<TimeCodeValidRes>
            {
                new() { TimeCode = "TC001", WorkGroup = "WG001", ParentProject = parentProject, JobCode = jobCode, TestCode = testCode }
            };
            var apiResponse = new ApiResponse<List<TimeCodeValidRes>>
            {
                Success = true,
            ...
            _http.GetAsync<List<TimeCodeValidRes>>(Arg.Is<string>(url =>
                url.Contains("api/v1/timecodevalid/pagedTest") &&
                url.Contains($"jobCode={Uri.EscapeDataString(jobCode)}") &&
                url.Contains($"testCode={Uri.EscapeDataString(testCode)}")))
                .Returns(apiResponse);
            _mapper.Map<ApiResponseDto<List<TimeCodeValidDto>>>(apiResponse).Returns(expectedDto);

            // Act
            var result = await _client.GetPagedTimeCodesTestCodeAsync(query, jobCode, testCode, parentProject);
        ...
        [Fact]
        public async Task GetPagedTimeCodesTestCodeAsync_WithTestCodeAndParentProjectOnly_IncludesBothInUrl()
        {
            // Arrange
            var query = new QueryParameters<string> { Page = 1, PageSize = 10 };
            var testCode = "TST001";
            ...
            var timeCodeList = new List<TimeCodeValidRes>
            {
                new() { TimeCode = "TC001", WorkGroup = "WG001", ParentProject = parentProject, TestCode = testCode }
            };
            var apiResponse = new ApiResponse<List<TimeCodeValidRes>>
            {
                Success = true,
            ...
            _http.GetAsync<List<TimeCodeValidRes>>(Arg.Is<string>(url =>
                url.Contains("api/v1/timecodevalid/paged/project/") &&
                url.Contains(Uri.EscapeDataString(parentProject)) &&
                url.Contains($"testcode/{Uri.EscapeDataString(testCode)}")))
                .Returns(apiResponse);
            _mapper.Map<ApiResponseDto<List<TimeCodeValidDto>>>(apiResponse).Returns(expectedDto);

            // Act
            var result = await _client.GetPagedTimeCodesTestCodeAsync(query, null, testCode, parentProject);
        ...
        [Fact]
        public async Task GetPagedTimeCodesTestCodeAsync_WithTestCodeOnly_IncludesTestCodeInUrl()
        {
            // Arrange
            var query = new QueryParameters<string> { Page = 1, PageSize = 10 };
            var testCode = "TST001";
            var timeCodeList = new List<TimeCodeValidRes>
            {
                new() { TimeCode = "TC001", WorkGroup = "WG001", TestCode = testCode }
            };
            var apiResponse = new ApiResponse<List<TimeCodeValidRes>>
            {
                Success = true,
            ...
            // Act
            var result = await _client.GetPagedTimeCodesTestCodeAsync(query, null, testCode, null);
        ...
        [Fact]
        public async Task GetPagedTimeCodesTestCodeAsync_WithJobCodeAndTestCode_IncludesBothInUrl()
        {
            // Arrange
            var query = new QueryParameters<string> { Page = 1, PageSize = 10 };
            var jobCode = "JC001";
            ...
            var timeCodeList = new List<TimeCodeValidRes>
            {
                new() { TimeCode = "TC001", WorkGroup = "WG001", JobCode = jobCode, TestCode = testCode }
            };
            var apiResponse = new ApiResponse<List<TimeCodeValidRes>>
            {
                Success = true,
            ...
            // Act
            var result = await _client.GetPagedTimeCodesTestCodeAsync(query, jobCode, testCode, null);
        ...
        [Fact]
        public async Task GetPagedTimeCodesTestCodeAsync_WithJobCodeAndParentProject_UsesJobCodeAndProjectUrl()
        {
            // Arrange
            var query = new QueryParameters<string> { Page = 1, PageSize = 10 };
            var jobCode = "JC001";
            ...
            // Act
            var result = await _client.GetPagedTimeCodesTestCodeAsync(query, jobCode, null, parentProject);
        ...
        [Fact]
        public async Task GetPagedTimeCodesTestCodeAsync_WithNullParameters_UsesBasePagedUrl()
        {
            // Arrange
            var query = new QueryParameters<string> { Page = 1, PageSize = 10 };
            var apiResponse = new ApiResponse<List<TimeCodeValidRes>>
            ...
            // Act
            var result = await _client.GetPagedTimeCodesTestCodeAsync(query, null, null, null);
        ...
        [Fact]
        public async Task GetPagedTimeCodesTestCodeAsync_WhenApiReturnsFailure_ReturnsFailureResponse()
        {
            // Arrange
            var query = new QueryParameters<string> { Page = 1, PageSize = 10 };
            ...
            // Act
            var result = await _client.GetPagedTimeCodesTestCodeAsync(query, "JC001", "TST001", "PP001");
