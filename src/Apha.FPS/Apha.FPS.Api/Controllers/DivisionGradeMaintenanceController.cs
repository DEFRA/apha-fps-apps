...
namespace Apha.FPS.Api.Controllers
{
    ...
    [Route("api/v{version:apiVersion}/divisiongrademaintenance")]
    [ApiController]
    [ApiVersion("1.0")]
    public class DivisionGradeMaintenanceController : ControllerBase
    {
        private readonly IDivisionGradeMaintenanceService _maintDGService;
        private readonly IMapper _mapper;

        public DivisionGradeMaintenanceController(IDivisionGradeMaintenanceService maintDGService, IMapper mapper)
        {
        ...
        {
            var dto = _mapper.Map<DivisionGradeMaintenanceDto>(request);
