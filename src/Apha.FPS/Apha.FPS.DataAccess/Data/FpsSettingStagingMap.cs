...
namespace Apha.FPS.DataAccess.Data
{
    public class FpsSettingStagingMap : IEntityTypeConfiguration<FpsSettingStaging>
    {
        public void Configure(EntityTypeBuilder<FpsSettingStaging> entity)
        {
            ...
            entity.ToTable("tblsettings_staging", "fps", tb => tb.HasComment("Application-level configuration settings. Only business-logic constants belong here; infrastructure config moves to appsettings.json."));
