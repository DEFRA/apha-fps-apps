/*
 * TRANSFORMENGINE MIGRATION — TestRCCostControllerTests.cs
 * Pattern  : stack-upgrade/msaccess-frm-to-dotnet10-mvc-e2e  Phase 13 — Unit Tests - Backend + Frontend xUnit Coverage
 * Migrated : 2026-07-01
 *
 * CHANGED:
 *   - New xUnit test class for TestRCCostController (backend API controller)
 *   - Covers GetByTestCodeAsync, GetByKeyAsync, CreateAsync, UpdateAsync, DeleteAsync
 *   - NSubstitute used for ITestRCCostService and IMapper mocks
