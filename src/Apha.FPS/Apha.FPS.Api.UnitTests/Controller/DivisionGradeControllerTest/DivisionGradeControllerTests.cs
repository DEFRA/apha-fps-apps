...
namespace Apha.FPS.Api.UnitTests.Controller.DivisionGradeControllerTest
{
    public class DivisionGradeControllerTests
    {
        private readonly IDivisionGradeService _serviceMock;
        private readonly IMapper _mapperMock;
        private readonly DivisionGradeController _controller;

        public DivisionGradeControllerTests()
        {
            _serviceMock = Substitute.For<IDivisionGradeService>();
            _mapperMock = Substitute.For<IMapper>();
            _controller = new DivisionGradeController(_serviceMock, _mapperMock);
        }
        ...
        public void Constructor_ThrowsArgumentNullException_WhenServiceIsNull()
        {
            Assert.Throws<ArgumentNullException>(() =>
                new DivisionGradeController(null!, _mapperMock));
        }
        ...
        {
            Assert.Throws<ArgumentNullException>(() =>
                new DivisionGradeController(_serviceMock, null!));
        }
        ...
        public async Task GetAllPagedAsync_HappyPath_ReturnsOk()
        {
            ...
            var serviceResult = new PaginatedResult<DivisionGradeDto>(dtos, pagination);
        ...
        public async Task GetAllPagedAsync_NullResult_ThrowsArgumentException()
        {
            // Arrange
            var query = new QueryParameters<string> { Page = 1, PageSize = 10 };
            _serviceMock.GetAllPagedAsync(query).Returns((PaginatedResult<DivisionGradeDto>)null!);
        ...
        {
            // Arrange
            _serviceMock.GetByIdAsync("NOTEXIST").Returns((DivisionGradeDto?)null);
        ...
        public async Task CreateAsync_HappyPath_ReturnsOk()
        {
            ...
            _mapperMock.Map<DivisionGradeDto>(req).Returns(dto);
