...
namespace Apha.Costbook.DataAccess.Data
{
    public class StaffRequirementMap : IEntityTypeConfiguration<StaffRequirement>
    {
        public void Configure(EntityTypeBuilder<StaffRequirement> entity)
        {
            ...
            entity.HasKey(e => e.SrIdentity).HasName("pk_tblstaffrequ");

            entity.ToTable("tblstaffrequ", DbConstants.MabArchiveSchemaName);

            entity.HasIndex(e => e.Project, "idx_tblstaffrequ_project");

            entity.HasIndex(e => new { e.Project, e.Year }, "idx_tblstaffrequ_project_year");
